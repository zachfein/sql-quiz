...
class Database():
    ...
    def connect():
        ...
        # Don't forget to update the "secrets.sh" file with your Postgres username and password, then run the "source" command on it to export them as environment variables.
